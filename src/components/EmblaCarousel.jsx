...
export function EmblaCarousel() {
  ...
  return (
    <div
      className={`flex flex-col items-center justify-center py-[50px] md:py-[100px] px-2 ${
        theme === "light" ? "bg-[#E7F6FD]" : "bg-gray-900"
      }`}
    >
      <h1
        className={`text-4xl ${
          theme === "light" ? "text-black" : "text-white"
        } text-center md:text-5xl font-extrabold leading-tight tracking-tight mb-[50px]`}
      >
        Find a Roommate Who -{" "}
      ...
      <div
        className="embla max-w-7xl rounded-3xl shadow-xl cursor-grab"
        ref={emblaRef}
      >
        <div className="embla__container rounded-3xl">
          ...
          <div className="embla__slide"><BannerOne></BannerOne></div>
          <div className="embla__slide"><BannerTwo></BannerTwo></div>
          <div className="embla__slide"><BannerThree></BannerThree></div>
        </div>
      </div>
    </div>
  );
