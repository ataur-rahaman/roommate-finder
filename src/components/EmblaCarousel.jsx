...
export function EmblaCarousel() {
  ...
  return (
    <div className='flex flex-col items-center justify-center py-[50px] md:py-[100px] px-2 bg-[#E7F6FD]'>
        <h1 className='text-4xl text-black text-center md:text-5xl font-extrabold leading-tight tracking-tight mb-[50px]'>Find a Roommate Who <span className='text-[#0EA5E9]'>Fits Your Life</span></h1>
