          ...
          <div className="card-body rounded-2xl">
            ...
            <form onSubmit={handleRegister}>
              <motion.input
                ...
                type="text"
                name="name"
                className="input mb-2 focus:border-2 focus:border-[#0EA5E9] focus:outline-0 focus:shadow-none rounded-4xl w-full"
                placeholder="Name"
                required
              />
              <motion.input
              ...
              {
                  errorMessage && <div className="max-w-11/12 text-[14px] px-2 py-1 text-red-500 rounded">
                  {
              ...
              <input
                className="btn mt-4 bg-[#0EA5E9] hover:bg-[#0284C7] text-white border-0 w-full rounded-4xl"
                type="submit"
                value="SignUp"
              />
